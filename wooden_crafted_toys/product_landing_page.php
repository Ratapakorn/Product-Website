...
<body>
  <div class="container">
    <nav class="vertnavbar">
      <ul>
          ...
          <div class="dropdownfunctionality">
              <li><a class="dropdownbutton" href="product_landing_page.html"><i class="fa fa-archive"></i>Products</a></li>
              <div class="dropdowncontent">
                  <a href="product_landing_page.html">Toys</a>
                  <a href="product_landing_page.html">Decorations</a>
              </div>
          </div>
          <li><a href="../content/customer.html"><i class="fa fa-user"></i>User Information</a></li>
    ...
    <div class="content">
      ...
      <div class="grid-container">
        <div class="grid-item">
            ...
            <p>Decorations</p>
            <a href="Product1_page.html"><p class="producttitle">Product 0</p></a>
        ...
        <div class="grid-item">
          <img class="prodimg" src="../images/product_wt_1.png" alt="img no available">
          <p>Decorations</p>
          <a href="Product1_page.html"><p class="producttitle">Product 1</p></a>
      ...
      <div class="grid-item">
        <img class="prodimg" src="../images/product_wt_1.png" alt="img no available">
        <p>Decorations</p>
        <a href="Product1_page.html"><p class="producttitle">Product 2</p></a>
        <p class="productprice">€10.348.692</h3>
        <br>
        <br>
        <div class="setCenter">
    ...
    <div class="grid-item">
      <img class="prodimg" src="../images/product_wt_1.png" alt="img no available">
      <p>Decorations</p>
      <a href="Product1_page.html"><p class="producttitle">Product 3</p></a>
      <p class="productprice">€10.348.692</h3>
      <br>
      <br>
      <div class="setCenter">
